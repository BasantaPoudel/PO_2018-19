...
do
	...
	if diff auto-tests/expected/$FILE.out results/$FILE.outhyp >/dev/null ; then
		...
		echo -e $"________1______________________________________________________________________________________________________" >> log/$FILE.log
		cat results/$FILE.outhyp >> log/$FILE.log
		echo -e $"________2______________________________________________________________________________________________________" >> log/$FILE.log
		cat auto-tests/expected/$FILE.out  >> log/$FILE.log
